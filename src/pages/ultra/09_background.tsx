...
async function changeBackground (ultra: UltraComponentRef, tower: Vim) {
  const r = ultra.viewer.renderer
  r.backgroundColor = new ULTRA.RGBA(0, 0, 0, 0)
...
function nudgeColor (color: ULTRA.RGBA): ULTRA.RGBA {
