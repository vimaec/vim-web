...
export function updateModal (modal: ModalRef, state: VIM.Core.Ultra.ClientState) {
...
export async function updateProgress (request: VIM.Core.Ultra.ILoadRequest, modal: ModalRef) {
