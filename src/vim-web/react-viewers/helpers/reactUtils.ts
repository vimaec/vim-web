...
// The observable core (StateRef, FuncRef, createState) is framework-neutral and shared with the
// DS layer; it lives in src/vim-web/state. Only the React hooks remain here.
import { type StateRef, type FuncRef, createState } from '../../state'
export type { StateRef, FuncRef }
export { createState }
