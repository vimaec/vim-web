...
export async function getVimData (vim: VIM.WebglVim): Promise<BIM.Data> {
...
export async function getHeader (vim: VIM.WebglVim): Promise<BIM.Entry[]> {
...
export async function getBody (vim: VIM.WebglVim): Promise<BIM.Section[] | undefined> {
