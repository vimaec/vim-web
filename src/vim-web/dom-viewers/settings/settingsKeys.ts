...
export class SettingsPanelKeys {
  // === Inputs ===
  static InputsSubtitle = 'inputs'
  static InputsScrollSpeedBox = 'scrollSpeed'
  ...
  static PanelsShowAxesPanelToggle = 'axesPanel'
  static PanelsShowPerformancePanelToggle = 'performance'

  // === Axes ===
  static AxesSubtitle = 'axes'
  static AxesShowOrthographicButtonToggle = 'orthographic'
  static AxesShowResetCameraButtonToggle = 'resetCamera'

  // === Control Bar ===
  static ControlBarSubtitle = 'controlBar'
  static ControlBarShowControlBarToggle = 'controlBarVisible'

  // --- Control Bar - Cursors ---
  static ControlBarCursorsSubtitle = 'controlBarCursors'
  static ControlBarCursorsShowOrbitButtonToggle = 'orbit'
  static ControlBarCursorsShowLookAroundButtonToggle = 'lookAround'
  static ControlBarCursorsShowPanButtonToggle = 'pan'
  static ControlBarCursorsShowZoomButtonToggle = 'zoom'
  static ControlBarCursorsShowZoomWindowButtonToggle = 'zoomWindow'
