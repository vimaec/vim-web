...
import { ControlBarCameraSettings, ControlBarCursorSettings, ControlBarMeasureSettings, ControlBarSectionBoxSettings, ControlBarVisibilitySettings } from '../controlbar/sectionSettings'
import { PointerMode } from "../../core-viewers"

export type PartialWebglSettings = RecursivePartial<WebglSettings>
  
/**
 * UI feature toggles, passed to `Dom.Webgl.createViewer(container, settings)`.
 ...
 *
 * @example
 * const viewer = await Dom.Webgl.createViewer(div, {
...
/**
 * Default settings configuration for the WebGL viewer
 * @constant
 * @type {WebglSettings}
 */
