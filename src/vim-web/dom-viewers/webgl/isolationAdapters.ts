...
import type { ISelectable } from '../../core-viewers/webgl'
import type { IIsolationAdapter, IRenderSettingsAdapter, VisibilityStatus } from '../state/isolation'
import type { IsolationSettings } from './settings'

/**
 * The WebGL isolation and render-settings adapters: plain closures over the
 * core, shared between the two APIs (showGhost and showTransparent both
 * rebuild the material set; rooms gate every visibility write).
 */
