...
import { ControlBarCameraSettings, ControlBarCursorSettings, ControlBarSectionBoxSettings, ControlBarVisibilitySettings } from '../controlbar/sectionSettings'
...
/**
 * UI feature toggles for the Ultra viewer, passed to `Dom.Ultra.createViewer(container, settings)`.
 * Controls which UI panels and toolbar buttons are shown.
 * Access at runtime via `viewer.ui.controlBar.set(false)`.
 *
 * @example
 * const viewer = await Dom.Ultra.createViewer(div, {
